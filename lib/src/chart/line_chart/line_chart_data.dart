...
import 'package:fl_chart/src/chart/line_chart/line_chart_shadow.dart';
...
class LineChartBarData with EquatableMixin {
  ...
  LineChartBarData({
    ...
    LineChartStepData lineChartStepData,
        ...
        dashArray = dashArray,
        shadow = shadow ?? const LineChartShadow(color: Colors.transparent),
